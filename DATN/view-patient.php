                                    ...
                                    function updateBodyTemperature() {
                                        ...
                                        xhr.onreadystatechange = function() {
                                            if (xhr.readyState === 4 && xhr.status === 200) {
                                                ...
                                                if (parseInt(response) < 36) {
                                                    var alertMessage =
                                                        'Low Temperature Alert! Your Temperature is lower than 36.';
                                                ...
                                                if (parseInt(response) > 39) {
                                                    var alertMessage =
                                                        'High Temperature Alert! Your Temperature is higher than 39.';
                                                    var alertTimeout = 3000; // 3 seconds in milliseconds
                                                    var alertWindow = alert(alertMessage);
